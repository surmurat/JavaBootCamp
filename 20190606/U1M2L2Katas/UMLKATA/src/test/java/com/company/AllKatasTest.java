...
//
//         TestRadio radio = new TestRadio("Sony", "V32", 2, "WUNV", 30,true);
//
//         String expect = "Expected to be able to instantiate a TestRadio object";
//         assertTrue(expect, radio instanceof TestRadio);
//
//         expect = "Values should be initialized by the constructor and accessible by getters";
